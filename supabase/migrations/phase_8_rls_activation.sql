-- VoicePrint Phase 8 database security baseline
-- IMPORTANT: committed for review/manual application only.
-- This migration is intentionally NOT auto-applied by the assistant.
-- Enabling RLS changes database access semantics and should be explicitly reviewed.
