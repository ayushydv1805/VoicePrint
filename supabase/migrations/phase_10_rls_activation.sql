-- VoicePrint Phase 10 database security activation
-- Enables row-level security for every public safety table and hardens
-- the existing timestamp trigger function search path.
...
alter function public.set_voiceprint_updated_at() set search_path = public;
