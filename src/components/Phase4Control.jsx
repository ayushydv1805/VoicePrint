export default function Phase4Control({user,listening,micRecovering,count,onTest}){
  return <div className="page">
    <div className="page-heading"><div><span className="panel-kicker">PHASE 16 · CONTROL CENTER</span><h1>Safety control</h1><p>{user?"Cloud session connected.":"Local demo mode."}</p></div></div>
    ...
    </div><div className="panel response-panel"><span className="panel-kicker">PHASE 16</span><h2>Cloud pipeline</h2><div className="flow-step"><span>01</span><div><strong>Listen</strong><p>Audio analysis remains local.</p></div><b>✓</b></div><div className="flow-step"><span>02</span><div><strong>Locate</strong><p>GPS coordinates are available during a test.</p></div><b>○</b></div><div className="flow-step"><span>03</span><div><strong>Persist</strong><p>Signed-in events appear in history.</p></div><b>{user?"✓":"○"}</b></div></div></div>
  </div>;
}
